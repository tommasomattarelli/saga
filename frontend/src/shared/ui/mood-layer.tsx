...
const MOOD_OVERLAYS: Record<string, MoodOverlay> = {
  ...
  dread_horror: {
    background: "radial-gradient(ellipse at center, transparent 20%, rgba(10,0,10,0.7) 100%)",
    opacity: 1,
  },
  stealth_danger: {
    background:
  ...
  calm_exploration: {
    background: "radial-gradient(ellipse at 20% 10%, rgba(212,175,55,0.12) 0%, transparent 50%)",
    opacity: 1,
  },
  triumphant_victory: {
  ...
  social_intrigue: {
    background: "radial-gradient(ellipse at 80% 20%, rgba(168,85,247,0.08) 0%, transparent 50%)",
    opacity: 1,
  },
  melancholic_reflection: {
    background: "linear-gradient(to bottom, rgba(30,30,50,0.3) 0%, transparent 60%)",
    opacity: 1,
  },
  mourning_loss: {
