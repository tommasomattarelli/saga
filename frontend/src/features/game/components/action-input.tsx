    ...
    <div className="border-t border-parchment-700/20 bg-parchment-900/95 px-6 py-4">
      ...
      <form onSubmit={handleSubmit} className="flex gap-3">
        <input
          ...
          disabled={isLoading}
          className="flex-1 rounded-lg border border-parchment-700/30 bg-parchment-800/50 px-4 py-3 font-serif text-parchment-100 placeholder-parchment-600 focus:border-gold-500/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500/40 disabled:opacity-50"
          autoFocus
        />
