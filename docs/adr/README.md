...
| [0017](0017-npc-dialogue-turn-architecture.md) | WIP | 2026-07-26 | NPC dialogue: mid-turn tool call vs. parallel pre-pass | The mid-turn `invoke_npc` tool serialises the DM and NPC models, and the DM skips it or paraphrases its result. Weighs a parallel pre-pass against it, under the constraint that the NPC's decisions stay its own. Nothing decided. |
