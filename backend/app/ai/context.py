...
async def build_context(
    ...
    Assembles:
    - System prompt from template + campaign state
    - Recent turn history
    - Active quests and companion state
    - Relevant semantic memories (via pgvector)
    ...
    # Score importance (basic heuristic, will be refined with AI scoring)
...
def score_importance(player_action: str, campaign: Campaign) -> int:
    ...
    Higher importance = premium model, lower = budget model.
    """
