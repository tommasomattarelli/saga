"""Streaming turn processing pipeline — yields events as the LLM generates tokens."""
...
from app.core.engine import CONTENT_POLICY_NARRATION, DICE_RE_PROMPT_TEMPLATE, StreamEvent
...
async def process_game_turn_streaming(
    ...
    if char_data.get("hp", {}).get("current", 1) <= 0:
        ...
        campaign.character_data = char_data
