...
[ ] companion: implementarli → ADR dedicato. Visione (2026-07-12): **ogni NPC è reclutabile** — prerequisito già deciso in 0010-I8 (schema NPC uniforme: traits+psicologia+statblock+inventario); il reclutamento è una **promozione di contenuto** che genera bene la mini-scheda completa (skill, abilità, inventario ben definito, equip vero), mai una migrazione di schema. Include: equip-layer NPC (fix del limite "guardia disarmata picchia ancora medium", 0010-I8), eventuale riapertura abilità NPC (0012-A2 oggi player-only).
